...
class AssignmentTests(TestCase):
    ...
    def test_time_ago_with_old_assignments(self):
        """
        time_ago() returns False for questions whose due_date
        is older than the current time.
        """
        self.assertEqual(self.assignment.time_ago(), '1 hour ago')
        
    def test_time_ago_with_recent_assignments(self):
        """
        time_ago() returns True for questions whose due_date
